    ...
    <Link href={`/products?category=${category.id}`}>
      ...
      >
        <div className="p-3 sm:p-4 md:p-6 text-center">
          {/* Category Icon */}
          <div className="relative w-12 h-12 sm:w-14 sm:h-14 md:w-20 md:h-20 lg:w-24 lg:h-24 mx-auto mb-2 sm:mb-3 md:mb-4 overflow-hidden rounded-full bg-gradient-to-br from-yellow-50 to-yellow-100 flex items-center justify-center group-hover:from-yellow-100 group-hover:to-yellow-200 transition-all duration-300">
            <IconComponent className="w-6 h-6 sm:w-7 sm:h-7 md:w-10 md:h-10 lg:w-12 lg:h-12 text-yellow-500 group-hover:text-yellow-600 transition-colors" />
          </div>
