...
export default function CategoryCard({ category, className }: CategoryCardProps) {
  ...
  return (
    <Link href={`/products?category=${category.id}`}>
      <div className={`group hover:shadow-xl transition-all duration-300 hover:scale-105 rounded-xl md:rounded-2xl border-0 shadow-sm bg-white cursor-pointer ${className}`}>
        <div className="p-3 md:p-6 text-center">
          ...
          {/* Category Name */}
          <h3 className="font-semibold text-xs md:text-sm lg:text-base text-gray-900 group-hover:text-yellow-600 transition-colors mb-1 md:mb-2">
            {category.name}
          </h3>
