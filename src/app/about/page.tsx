    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="text-center mb-12">
        ...
        <p className="text-lg text-gray-600 max-w-3xl mx-auto">
          Your trusted electronics store in Bangladesh, bringing you the latest technology 
          with reliable service and competitive prices since our establishment.
        </p>
      </div>
      ...
      <div className="grid md:grid-cols-2 gap-12 mb-16">
        <div>
          ...
          <p className="text-gray-600 mb-4">
            TechPinik was founded with a simple mission: to make quality electronics 
            accessible to everyone in Bangladesh. We started as a small electronics 
            shop and have grown into a trusted online platform serving customers 
            across the country.
          </p>
          <p className="text-gray-600 mb-4">
            Our commitment to customer satisfaction, authentic products, and 
            competitive pricing has made us a preferred choice for tech enthusiasts 
