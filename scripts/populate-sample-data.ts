...
const productsData = [
  {
    ...
    image_url:
      'https://trae-api-sg.mchost.guru/api/ide/v1/text_to_image?prompt=samsung%20galaxy%20smartphone%20modern%20sleek%20design&image_size=square',
    is_featured: true,
    is_active: true,
  },
  {
    ...
    image_url:
      'https://trae-api-sg.mchost.guru/api/ide/v1/text_to_image?prompt=apple%20iphone%20premium%20smartphone%20elegant&image_size=square',
    is_featured: true,
    is_active: true,
  },
  {
    ...
    image_url:
      'https://trae-api-sg.mchost.guru/api/ide/v1/text_to_image?prompt=cotton%20t-shirt%20comfortable%20casual%20fashion&image_size=square',
    is_featured: false,
    is_active: true,
  },
  {
    ...
    image_url:
      'https://trae-api-sg.mchost.guru/api/ide/v1/text_to_image?prompt=modern%20LED%20table%20lamp%20adjustable%20home&image_size=square',
    is_featured: false,
    is_active: true,
  },
]
...
async function populateDistricts() {
  ...
  const { data, error } = await supabase.from('districts').insert(bangladeshDistricts).select()
...
async function populateCategories() {
  ...
  const { data, error } = await supabase.from('categories').insert(sampleCategories).select()
...
async function populateSliderItems() {
  ...
  const { data: existingSliders } = await supabase.from('slider_items').select('id')
  ...
  const { data, error } = await supabase.from('slider_items').insert(sliderData).select()
